export function IntroText() {
  return (
    ...
    >
      ...
      <h1 className="text-lg text-[#F9A825] sm:text-xl md:text-5xl lg:text-7xl lg:pb-10 text-white font-bold mb-2 sm:mb-3 leading-tight md:leading-[1.2] lg:leading-[1.2]">
        OBALOVÝCH MATERIÁLŮ
      </h1>
